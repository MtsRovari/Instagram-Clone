package com.example.mateusrovari.instagramclone.models;
...
public class UserAccountSettings implements Parcelable{
    ...
    public UserAccountSettings(String description, String display_name, long phone_number, long followers, long following,
